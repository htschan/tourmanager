...
# Create a special Dockerfile for the CI/CD pipeline
# This file incorporates the nuclear fix directly into the build process

mkdir -p /home/hts/pj/komoot/backend/ci-build
cat > /home/hts/pj/komoot/backend/ci-build/Dockerfile << 'EOF'
...
echo "✅ Created CI/CD special Dockerfile with nuclear fix at /home/hts/pj/komoot/backend/ci-build/Dockerfile"
